...
-----END CERTIFICATE-----`)
	...
	rootx2byx1 = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	...
	rootyebyx2 = []byte(`-----BEGIN CERTIFICATE-----

HJfxqFCSyj39rUtm+bGw8GwaxAHVgdin+SAlO91BUhfFblsx
-----END CERTIFICATE-----`)
	// https://letsencrypt.org/certs/gen-y/root-yr.pem
	rootyr = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	...
	rootyrbyx1 = []byte(`-----BEGIN CERTIFICATE-----
MIIF3zCCA8egAwIBAgIRAPqmJ13CWEMdl2bsMEXvJKwwDQYJKoZIhvcNAQELBQAw
TzELMAkGA1UEBhMCVVMxKTAnBgNVBAoTIEludGVybmV0IFNlY3VyaXR5IFJlc2Vh
cmNoIEdyb3VwMRUwEwYDVQQDEwxJU1JHIFJvb3QgWDEwHhcNMjUwOTAzMDAwMDAw
...

-----END CERTIFICATE-----`)
	// https://letsencrypt.org/certs/2024/e7.pem
	e7 = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	// https://letsencrypt.org/certs/2024/e7-cross.pem
	e7cross = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	// https://letsencrypt.org/certs/2024/e8-cross.pem
	e8cross = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	// https://letsencrypt.org/certs/2024/e9-cross.pem
	e9cross = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	...
	e5cross = []byte(`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`)
	...
	e6cross = []byte(`-----BEGIN CERTIFICATE-----
...
var certificates = [][]byte{isrgrootx1, isrgrootx1crosssigned, isrgrootx2, isrgrootx2crosssigned, rootx2byx1, rootye, rootyebyx2, rootyr, rootyrbyx1, e7, e7cross, e8, e8cross, r12, r13, intye1, intye2, intyr1, intyr2, e9, e9cross, r14, intye3, intyr3, letsencrypte1, letsencrypte2, e5, e5cross, e6, e6cross, letsencryptr3, letsencryptr3crosssigned, letsencryptr4, letsencryptr4crosssigned, r10, r11, letsencryptauthorityx1, letsencryptx1crosssigned, letsencryptauthorityx2, letsencryptx2crosssigned, letsencryptauthorityx3, letsencryptx3crosssigned, letsencryptauthorityx4, letsencryptx4crosssigned}
