...
var certificates = [][]byte{isrgrootx1, isrgrootx1crosssigned, isrgrootx2, isrgrootx2crosssigned, e5, e5cross, e6, e6cross, r10, r11, e7, e7cross, e8, e8cross, e9, e9cross, r12, r13, r14, letsencrypte1, letsencrypte2, letsencryptr3, letsencryptr3crosssigned, letsencryptr4, letsencryptr4crosssigned, letsencryptauthorityx1, letsencryptx1crosssigned, letsencryptauthorityx2, letsencryptx2crosssigned, letsencryptauthorityx3, letsencryptx3crosssigned, letsencryptauthorityx4, letsencryptx4crosssigned, isrgrootocspx1}
